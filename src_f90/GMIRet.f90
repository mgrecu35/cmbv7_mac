!begin 2/9/22 WSO pass status of granule
subroutine gmiretsub(icL,ichunk,orbNumb,ialg,idir,iGMITMI2_c)
!end 2/9/22
  use globalData
  use f90DataTypes
  use f90Types
...
!begin 2/9/22 WSO granule status flag
  integer :: iGMITMI2_c
!end 2/9/22
...
!begin 2/9/22 WSO check for bad granule added
  if(testlat < missing_r4 + 1. .or. testlon < missing_r4 + 1. .or. iGMITMI2_c < 0) then  !bad geolocation or bad granule
    if(iGMITMI2_c < 0) print*, "iGMITMI2_c: ", iGMITMI2_c, "  bad 2nd GMI/TMI granule"
!end 2/9/22
